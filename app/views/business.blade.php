                ...
                <div class="section-title center"><br>
                    ...
                    <div style="font-size: larger;color: #6F6F6F;">
                        <div class="text-justify">
                            ...
                            <ul class="about-list">
                                <li><span class="fa fa-dot-circle-o"></span> <u>Account management</u>: FieldMax® mobile application gives the ground level sales force a clear visibility of the customers and accounts he manages on a daily basis. A Holistic view of customer with their related contacts, opportunities and much more helps the sales personal keep track of customer interaction, status of opportunities, view past sales history providing better visibility for effective sales engagement and follow-ups.</li>
                                <li><span class="fa fa-dot-circle-o"></span> <u>Complete field automation</u>: FieldMax® automates the entire field activities by eliminating paper forms and phone/ fax/ email based sales reporting. It makes available all critical inputs for the sales personnel, such as sales orders, collection details, sales returns information, stock status, order status, shipment details and receivables, on their finger tips.</li>
                                <li><span class="fa fa-dot-circle-o"></span> <u>Real time information</u>: The solution supports real time, bi-directional exchange of data. This allows sales order details from field to be made available to back office staff without any delay. Field users can also easily access enterprise data from backend systems (ERP, Accounting systems).</li>
                                <li><span class="fa fa-dot-circle-o"></span> <u>Improved information tracking</u>: Field staff has access to information from enterprise systems on their mobile devices. Back office staff gets real time information from the field to schedule delivery of products. Retailers/ customers receive instant acknowledgement of payments made via SMS from back office. Finance and Business Managers get most current status on cash flow and sales performance.</li>
                            </ul>
                            ...
                            <ul class="about-list">
                                ...
                                <li><span class="fa fa-dot-circle-o"></span> <u>Faster sales</u>: order cycles: Back offices activities in order processing and delivery can be initiated in real time which leads to drastic reduction of order-to delivery time. Faster sales order cycle translates to faster revenue recognition. </li>
                            </ul>
