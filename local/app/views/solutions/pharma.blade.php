            ...
            <div class="container text-center">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-8">
                                ...
                                <div style="font-size: larger;color: #6F6F6F;">
                                    <div class="text-justify">
                                        <ul class="about-list">
                                            ...
                                            <li><span class="fa fa-dot-circle-o"></span>  Doctor/Chemist/stockist visit planning</li>
                                            <li><span class="fa fa-dot-circle-o"></span>  Attendance and Expense management</li>
                                        </ul></div>
                                    </div>
                            </div>
                        ...
                        <div class="col-xs-4">
                            <img src="assets/images/pharma.jpg" class="img-responsive" alt="">
                        </div>
                    </div>
